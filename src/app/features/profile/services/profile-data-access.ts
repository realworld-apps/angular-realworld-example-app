...
/**
 * ProfileDataAccess - Fetches public profile data for any user by username.
 *
 * Note: This is different from User which uses GET /user:
 * - GET /profiles/:username → Public profile for any user (this service)
 * - GET /user → Current authenticated user's own data (User)
 */
