...
test.describe('Pagination', () => {
  ...
  test('pagination should update URL with ?page=N', async ({ page, request }) => {
    ...
    await expect(page.locator('.pagination button:has-text("2")')).toBeVisible({ timeout: 15000 });
  ...
  test('pagination URL preserves feed=following parameter', async ({ page }) => {
    ...
    await page.waitForSelector('.article-preview, .empty-feed-message', { timeout: 15000 });
